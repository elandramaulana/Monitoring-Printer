                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 style="font-weight:bold;" class="h4 text-gray-900 mb-4">Form Ubah Printer</h1>
                                    </div>
                                    ...
                                    <form class="" method="post">
                                        ...
                                        <div class="form-group">
                                            <input name="loc" type="text" class="form-control form-control-user"
                                                id="location" value="<?= $printer['site'];?>"placeholder="Printer Location">
                                        </div>
                                        <div class="form-group">
                                            <input value="<?= $printer['nama_unit'];?>" name="unit" type="text" class="form-control form-control-user"
                                                id="unitName" placeholder="Unit Name">
                                        </div>
                                        <div class="form-group">
                                            <input value="<?= $printer['serial_number'];?>" name="serial_number" type="text" class="form-control form-control-user"
                                                id="serialNumber" placeholder="Serial Number">
                                        </div>
                                        <div class="form-group">
                                            <input value="<?= $printer['ip'];?>" name="ip" type="text" class="form-control form-control-user"
